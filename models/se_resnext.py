...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, num_group=64):
...
class SE_ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=7, num_group=64):
        self.inplanes = 64
        ...
        self.output_norm = nn.BatchNorm1d(512, eps=1e-05)
        nn.init.constant_(self.output_norm.weight, 1.0)
        self.output_norm.weight.requires_grad = False
